...
var sync_token_from_session = function (asyncTokenId) {
	...
	<body ng-app="myApp" ng-controller="myCtrl">
		<div class="login">
			<h3>红黄蓝幼儿园教学系统 后台</h3>
			<form method="post">
				<input type="text" autofocus="autofocus" ng-model="username" placeholder="用户名" required="required"/>
				<input type="password" ng-model="password" placeholder="密码" required="required">
...
<script src="<%=cachePath %>/res/js/jquery/jquery-1.11.3.min.js"></script>
	...
	<script src="<%=cachePath %>/res/js/md5.js"></script>
<script>
$().ready(function(){
...
app.controller('myCtrl', function($scope) {
	...
	$scope.login=function(){
		var url=contextPath+"/api/users/loginAdmin";
			var params=new Array();
			params.push("username="+$scope.username);
			params.push("password="+hex_md5($scope.password));
